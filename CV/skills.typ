...
#list(
  [*Coding Languages:* Python, Go, C, C++, Bash, Lua, SQL, MATLAB, Mathematica, Octave, LaTeX, #link("https://github.com/typst/typst")[Typst]],
  [*Software:* Simulink, SolidWorks, OpenMC, COG (transport code), NJOY2016, Vim, Neovim, Pytorch, Scikit-learn, Slurm, Git, Linux, Arduino, Microsoft Office],
