...
#experience_field("Lawrence Berkeley National Laboratory", "Lab Affiliate", "Berkeley, CA", "Aug 2025 - present", list([Studied slung-payload algorithms for a radiation detector tethered to an autonomous hexacopter]))
