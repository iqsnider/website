...
#list(
  ...
  [*Math:* Linear Algebra, ODEs, Computing Structures, Control Systems, Machine Learning, Random Walks, Random Matrix Theory, Special Orthogonal Groups, and Optimizations]
)
