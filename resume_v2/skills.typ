...
#list(
  ...
  [*Software/Technical:* Simulink, SolidWorks, OpenMC, COG (transport code), NJOY2016, Pytorch, Scikit-learn, Slurm, Git, Linux, Arduino, Microsoft Office, Robotics, Computer Clusters, Embedded Electronics],
